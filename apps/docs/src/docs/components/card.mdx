...
- [Table](/components/table) - For structured data display
- [Badge](/components/badge) - For status indicators in cards
- [Button](/components/button) - For card actions
- [AspectRatio](/components/aspect-ratio) - For card images
