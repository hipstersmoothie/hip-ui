...
- [Button](/components/button) - For file upload triggers
- [Card](/components/card) - For containing file drop zones
- [Badge](/components/badge) - For file upload status indicators
- [Typography](/components/typography) - For file upload instructions
