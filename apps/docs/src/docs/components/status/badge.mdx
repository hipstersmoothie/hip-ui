...
- [Avatar](/docs/components/avatar) - For user avatars with status badges
- [Card](/docs/components/card) - For cards with status badges
- [Table](/docs/components/table) - For table cells with status badges
- [Button](/docs/components/button) - For buttons with notification badges
