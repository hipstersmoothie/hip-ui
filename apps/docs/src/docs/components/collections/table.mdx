...
> NOTE: The table alsso supports `replace` as a `selectionBehavior`.
> React more about it [here](https://react-spectrum.adobe.com/react-aria/Table.html#selection-behavior).
