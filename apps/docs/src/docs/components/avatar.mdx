...
- [Card](/components/card) - For cards with user avatars
- [AspectRatio](/components/aspect-ratio) - For maintaining avatar aspect ratios
- [Typography](/components/typography) - For text alongside avatars