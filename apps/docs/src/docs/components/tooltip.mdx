...
- [IconButton](/components/icon-button) - Often used with tooltips for context
- [Button](/components/button) - Can be enhanced with tooltips
- [Badge](/components/badge) - Can be enhanced with tooltips for additional info
